import { FaSquareFacebook, FaLinkedin, FaWhatsapp, FaStackOverflow, FaTelegram, FaSquareXTwitter, FaRedditAlien, FaDiscord, FaGithub, FaYahoo } from "react-icons/fa6";
import { IoHomeOutline } from "react-icons/io5";
import { TfiEmail } from "react-icons/tfi";

const Footer = () => {
    return (
        <footer className="max-w-screen-2xl mx-auto bg-nhbBG text-white">
            <section className="md:py-8 p-6 md:px-12 flex sm:flex-row flex-col items-center sm:justify-between text-center sm:text-left gap-6">
                {/* Contacts */}
                <div className="flex flex-col gap-3 items-center sm:items-start justify-start">
                    ...
                    <h3 className="flex items-center gap-2"><IoHomeOutline />Sirajganj, Rajshahi, Bangladesh</h3>
                    <a className="flex items-center gap-2 hover:text-google" href="mailto:nazmulnhb@gmail.com" rel="noopener noreferrer">
                        <TfiEmail /> nazmulnhb@gmail.com
                    </a>
                ...
                <div className="text-2xl grid grid-cols-3 gap-4 !bg-transparent">
                    ...
                    <a className="flex items-center gap-2 hover:text-black hover:bg-white rounded-full hover:scale-150 transition-all duration-500" href="https://github.com/nazmul-nhb/" target="_blank" rel="noopener noreferrer">
                        <FaGithub />
                    </a>
                    <a className="flex items-center gap-2 hover:text-telegram hover:bg-white rounded-full hover:scale-150 transition-all duration-500" href="https://t.me/nhb42" target="_blank" rel="noopener noreferrer">
                        <FaTelegram />
                    </a>
            ...
            <p className="text-center text-sm pb-8">
                {new Date().getFullYear()} &copy; Nazmul Hassan. All Rights Reserved.
            </p>
        </footer>
    );
};
