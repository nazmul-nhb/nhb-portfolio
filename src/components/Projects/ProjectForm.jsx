...
const ProjectForm = ({ project, addProject, handleAddProject, handleUpdateProject, setShowUpdateForm }) => {
    ...
    return (
        <form
            ...
            {/* Submit Button */}
            <button title='Save' type="submit" className="absolute top-4 right-8 text-3xl text-teal-500 hover:scale-110 animate-growShrink hover:text-blue-50 transition-all duration-500">
                <FaRegSave />
            </button>
        </form>
    );
