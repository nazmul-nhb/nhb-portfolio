...
const Navbar = () => {
    ...
    return (
        <nav className="max-w-[1920px] bg-nhbBG text-white flex items-center justify-between gap-0 md:gap-4 mx-auto shadow-lg shadow-nhb px-6 py-3 md:px-12 sticky top-0 bg-opacity-75 h-16 z-20">
